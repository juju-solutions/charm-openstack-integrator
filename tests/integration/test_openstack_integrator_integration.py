...
async def test_build_and_deploy(ops_test):
    ...
    bundle, = await ops_test.async_render_bundles(ops_test.Bundle("kubernetes-core", channel="edge"))
    ...
    await ops_test.model.deploy("local:" + str(openstack_integrator), to="lxd:0", trust=True)
